<template>
  <div class="dashboard-container">
    ...
    <div class="overview-section">
      ...
      <div class="overview-card wallet-balance">
        ...
        <div class="card-content">
          ...
          <button class="crypto-wallet-btn" @click="goToCryptoWallet">Crypto Wallet</button>
        </div>
      </div>
    </div>
    ...
    <!-- Investment Wallet Addresses -->
    <div class="wallet-addresses-section">
      <h2>Investment Wallet Addresses</h2>
      <div class="wallet-addresses-grid">
      ...
      <p class="wallet-note">
        Use these wallet addresses to send cryptocurrency for investment. Your funds will be credited to your account balance.
      </p>
    </div>
      ...
      <div class="modal" @click.stop>
          ...
          <div class="investment-form">
            ...
            <div class="investment-summary">
              ...
              <div class="summary-item total">
                ...
                <span
                  >${{ formatNumber((investmentAmount || 0) * (1 + selectedPlan.roi / 100)) }}</span
                >
              </div>
            </div>
          </div>
        ...
        <div class="modal-actions">
          ...
          <button
            ...
            :disabled="
              !selectedPlan || !investmentAmount || investmentAmount < selectedPlan.minAmount
            "
          >
            Invest Now
          </button>
...
export default {
  ...
  data() {
    return {
      ...
      selectedCrypto: 'BTC',
      bitcoinWalletAddress: 'bc1qguk7k34dr64ly2rmn2l0mwsrvk553fa8c8yl7c',
      ethereumWalletAddress: '0xBE4D058F6f12dE10158B2F9837eB65208FE4036f',
    }
  },
  computed: {
    isWithdrawalFormValid() {
      return this.cryptoWithdrawalAddress
    },
  },
  mounted() {
    this.loadUserData()
  ...
  methods: {
    ...
    createInvestment() {
      ...
      const newInvestment = {
        ...
        endDate: new Date(Date.now() + this.selectedPlan.duration * 24 * 60 * 60 * 1000)
          .toISOString()
          .split('T')[0],
      }
    ...
    processWithdrawal() {
      if (!this.withdrawAmount || !this.cryptoWithdrawalAddress) return
      ...
      alert(
        'Crypto withdrawal request submitted successfully! It will be processed within 24-48 hours.',
      )
    },
