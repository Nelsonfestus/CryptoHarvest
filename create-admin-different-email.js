...
async function createAdminWithDifferentEmail() {
  console.log('🔧 Creating Admin User with Different Email...')
  console.log(`📧 Using email: ${ADMIN_EMAIL}`)
  
  try {
    // Step 1: Check if admin user already exists
    console.log('\n📊 Step 1: Checking existing admin users...')
    ...
    console.log('📊 Existing admin users in database:')
